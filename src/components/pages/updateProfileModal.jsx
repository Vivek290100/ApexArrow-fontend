    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogTitle className="text-xl font-semibold mb-4 pr-8">
        ...
        className="space-y-3">
          ...
          {
                loading? (
                  <button className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gradient-to-r from-yellow-400 to-violet-700  hover:bg-gradient-to-r"><Loader className="mr-2 h-5 w-5 animate-spin"></Loader>please wait</button>
                ) : (
