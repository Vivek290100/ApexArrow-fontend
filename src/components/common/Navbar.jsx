      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          {location.pathname === "/jobs" && (
            <div className="hidden md:block flex-grow max-w-xl mx-12">
              <div className="relative w-full">
                <input
                  type="text"
                  className="w-full px-4 py-1 border text-gray-600 rounded-full focus:outline-none focus:ring-2 focus:ring-indigo-500"
